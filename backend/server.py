    ...
    async for message in websocket:
        ...
        match data["type"]:
            case "ReadyForSpeech":
                ...
                prompt = "Hey, Melba! Tell us a tongue twister!"
                text = "Oi, mates. You wanna hear a tongue twister? Melba's toaster toast toasticular toast that taste as tasty toasty. Peace out! Try saying that three times fast."

                another = not another

                if another:
                    filename = "bee.mp3"
                    prompt = "Cite the Bee Movie, please!"
